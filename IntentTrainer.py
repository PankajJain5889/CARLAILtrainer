...
train_loader = Loader('/mnt/data001/png_json_data/SingleWeather/mixed_data/Train/' ,'training_data',Branches , BranchCommands)
val_loader = Loader('/mnt/data001/png_json_data/SingleWeather/mixed_data/Val/' , 'validation_data',Branches , BranchCommands)
    ...
    with sess.as_default():
        ...
        for epoch in range(epochs): #1st loop for epochs 
            ...
            if lr_counter ==  MAX_LR_COUNTER:
                ...
                print("\tloading last best model from " , model_path)
