...
train_loader = Loader('/mnt/data001/New_Pos_H5_Collection/train/*/' ,'training_data',Branches , BranchCommands)
val_loader = Loader('/mnt/data001/New_Pos_H5_Collection/val/*/' , 'validation_data',Branches , BranchCommands)
